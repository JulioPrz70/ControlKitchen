...
public class ComprasInv extends javax.swing.JFrame {
    ...
    public ComprasInv() {
        ...
        btnUsuarios.setEnabled(false); //SE BLOQUEA EL BOTON AGREGAR
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComprasInv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ComprasInv().setVisible(true);
            }
        });
    }
