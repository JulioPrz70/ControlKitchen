...
public class ResultadoProduccion extends javax.swing.JFrame {
    
    public ResultadoProduccion() {
    ...
    private void initComponents() {
        ...
        TablaProduccion.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No_Producción", "Usuario", "Fecha", "Hora"
            }
        ) {
        ...
        TablaDetalle.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id_DetalleProducción", "No_Producción", "Producto", "Cantidad", "Costo_Unitario", "Caducidad"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.Integer.class, java.lang.Float.class, java.lang.String.class
            };
            boolean[] canEdit = new boolean [] {
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        try {
            ...
            String path = "src\\Reportes\\ReporteProduccion.jasper";
            
            int id = Integer.parseInt(ConsultaProduccion.txtNoProduccion.getText());
            Map parametro = new HashMap();
            parametro.put("no_produccion", id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResultadoProduccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResultadoProduccion().setVisible(true);
            }
        });
    }
